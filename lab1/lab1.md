1. Найти способ определить количество запущенных задач на компьютере при помощи графического интерфейса и интерфейса командной строки![[Pasted image 20250911140204.png]]
